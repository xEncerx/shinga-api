...
class AsyncHttpClient:
    ...
    def __init__(
        ...
        Args:
            ...
            timeout: Request timeout in seconds. Defaults to 15.0 seconds.
        ...
        self._timeout = ClientTimeout(total=timeout or 300)
        self._proxy = proxy
    ...
    async def _create_session(self) -> None:
        ...
        Applies SSL, proxy, timeout, and base URL configurations.
        """
    ...
    def request(
        ...
        **kwargs: Unpack[_RequestOptions],
        ...
        Args:
            ...
            url: URL for the request (relative or absolute)
            **kwargs: All parameters supported by aiohttp (params, headers, data, json, etc.)
    ...
    def get(
        ...
        **kwargs: Unpack[_RequestOptions],
        ...
        Args:
            ...
            **kwargs: All parameters supported by aiohttp (params, headers, etc.)
    ...
    def post(
        ...
        **kwargs: Unpack[_RequestOptions],
        ...
        Args:
            url: URL for the request
            **kwargs: All parameters supported by aiohttp (data, json, headers, etc.)
